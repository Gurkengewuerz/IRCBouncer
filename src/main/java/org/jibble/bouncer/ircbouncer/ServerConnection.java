...
public class ServerConnection extends PircBot {
    ...
    public ServerConnection(String server, int port, String password, String nick, User user, String[] channel) {
        this.server = server;
        this.port = port;
        ...
        setName(nick);
        setLogin(JBouncerMain.prefix);
        setVersion(JBouncerMain.realname);
        setVerbose(false);
    ...
    public String getCSV() {
        String csv = server + ";" + port + ";" + password + ";" + user.hashCode() + ";";
